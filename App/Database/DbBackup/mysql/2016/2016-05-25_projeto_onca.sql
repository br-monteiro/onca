-- 2016-05-25T18:46:30-03:00 - mysql:dbname=projeto_onca;host=localhost
...
INSERT INTO `coletas` VALUES (1464100000,1464101816,1464101816,'KG',50,10);
...
INSERT INTO `distribuicoes` VALUES (1464139116,1464100000,1464101816,1464106266,1464139116,'Y97LVZ',40,'KG');
UNLOCK TABLES;
...
INSERT INTO `usuarios` VALUES (1,'x1ehOYh2DKDb8D1RkVnlz2HokuEIV6zlcUVIyb9wczg=','$2y$11$US9rk8xnr2Wt.UGmCdVMfeDlocUhI/kIM3574dqWEuSf8zMFNt7pG','Administrador','OT/WcW+1wFygVHGhd/9nlCMjsNVTFkgXE2EHlw7Ekfw=',1,0,1445514631,1464143825,1);
UNLOCK TABLES;

-- Completed on: 2016-05-25T18:46:30-03:00
